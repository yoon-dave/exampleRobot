...
public class RobotContainer {
  ...
  public static void printDiagnostics() {
     ...
     * DrivetrainSubsystem.getInstance().getNavxConnected());
  ...
  private void configureButtonBindings() {
    ...
    Trigger dpadUp = new Trigger(() -> {
      return m_controller.getDpadUp();
    });
    Trigger dpadUpRight = new Trigger(() -> {
      return m_controller.getDpadUpRight();
    });
    Trigger dpadDown = new Trigger(() -> {
      return m_controller.getDpadDown();
    });
  ...
  //   // m_controller.getAButton().whenActive(new InstantCommand(() ->
  //   // IndexerSubsystem.getInstance().automaticIntaking()));
  //   m_controller.getAButton()
  //       .whenActive(new InstantCommand(() -> ShooterSubsystem.getInstance().setShooterVelocity(shooterIdle)));
  //   m_controller.getYButton().whenActive(new RobotOff());

  //   m_controller.getLeftBumper().whenHeld(new EjectBall());
  //   // m_controller.getLeftBumper().whenHeld(new SetIntakeCommand(intakeReverse,
  //   // false));
  //   // m_controller.getLeftBumper().whenReleased(new SetIntakeCommand(intakeOn,
  //   // true));
  ...
  //     return m_controller.getLeftTriggerAxis() > triggerDeadzone;
  //   });
  //   Trigger rightTriggerAxis = new Trigger(() -> {
  //     return m_controller.getRightTriggerAxis() > triggerDeadzone;
  //   });

  //   // leftTriggerAxis.whileActiveOnce(new ShootByLimelight(true));
  //   // leftTriggerAxis.whileActiveOnce(new AimShoot());
  //   // leftTriggerAxis.whenInactive(new SequentialCommandGroup(new WaitCommand(0.6),
  //   // new RobotIdle()));
  ...
  //     return m_controller2.getDpadUp();
  //   });
  //   Trigger dpadDown2 = new Trigger(() -> {
  //     return m_controller2.getDpadDown();
  //   });
  //   Trigger dpadLeft2 = new Trigger(() -> {
  //     return m_controller2.getDpadLeft();
  //   });
  //   Trigger dpadRight2 = new Trigger(() -> {
  //     return m_controller2.getDpadRight();
  //   });
  ...
  //    * m_shooterSubsystem.increaseShooterVelocity(-250))); //works
  //    */
  //   // dpadRight2.whenActive(new InstantCommand(() ->
  //   // m_shooterSubsystem.setShooterVelocity(shooterFixed)));
  //   // dpadLeft2.whenActive(new InstantCommand(() ->
  ...
  //   Trigger leftTriggerAxis2 = new Trigger(() -> {
  //     return m_controller2.getLeftTriggerAxis() > triggerDeadzone;
  //   });
  //   Trigger rightTriggerAxis2 = new Trigger(() -> {
  //     return m_controller2.getRightTriggerAxis() > triggerDeadzone;
  //   });
  ...
  //    * .whenInactive(new SetIndexerCommand(0.0, false));
  //    */
  //   // m_controller2.getLeftBumper().whenPressed(new
  //   // SetIntakeCommand(intakeOn,true));
  //   // m_controller2.getRightBumper().whenPressed(new
  //   // SetIndexerCommand(indexerUp,true));

  //   leftTriggerAxis2
  //       .whileActiveContinuous(new InstantCommand(
  //           () -> ClimbSubsystem.getInstance().leftPivotPower(pivotDown * m_controller2.getLeftTriggerAxis())))
  //       .whenInactive(new InstantCommand(() -> ClimbSubsystem.getInstance().leftPivotPower(0)));
  //   rightTriggerAxis2
  //       .whileActiveContinuous(new InstantCommand(
  //           () -> ClimbSubsystem.getInstance().rightPivotPower(pivotDown * m_controller2.getRightTriggerAxis())))
  //       .whenInactive(new InstantCommand(() -> ClimbSubsystem.getInstance().rightPivotPower(0)));

  //   Trigger leftJoyStick = new Trigger(() -> {
  //     return Math.abs(m_controller2.getLeftY()) > triggerDeadzone;
  //   });
  //   Trigger rightJoystick = new Trigger(() -> {
  //     return Math.abs(m_controller2.getRightY()) > triggerDeadzone;
  //   });
  //   leftJoyStick
  //       .whileActiveContinuous(
  //           new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(-climbUp * m_controller2.getLeftY())))
  //       .whenInactive(new InstantCommand(() -> ClimbSubsystem.getInstance().leftClimbPower(0)));
  //   rightJoystick
  //       .whileActiveContinuous(new InstantCommand(
  //           () -> ClimbSubsystem.getInstance().rightClimbPower(-climbUp * m_controller2.getRightY())))
  //       .whenInactive(new InstantCommand(() -> ClimbSubsystem.getInstance().rightClimbPower(0)));

  //   // m_controller2.getXButton().whenHeld(new
  //   // SetIntakeCommand(intakeOn)).whenReleased(new SetIntakeCommand(0.0));
  //   m_controller2.getBButton().whenHeld(new SetIntakeCommand(0))
  //       .whenReleased(new InstantCommand(() -> IndexerSubsystem.getInstance().automaticIntaking()));
